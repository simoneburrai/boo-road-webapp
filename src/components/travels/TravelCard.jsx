        ...
        <>
            {travels.sort((a, b) => new Date(a.start) - new Date(b.start))
                .map((travel) => {
                    ...
                    return (
                        <div className="card travelcard d-flex flex-sm-row flex-column justify-content-around mb-3 mb-md-4 p-md-3 p-2" key={travel.id}>
                            ...
                            <div className="p-2">
                                ...
                                <div className="d-flex flex-row justify-content-between align-items-center  mb-4 durata px-3">
