        ...
        <>
            {travels.sort((a, b) => new Date(a.start) - new Date(b.start))
                .map((travel) => {
                    ...
                    return (
                        <div className="card travelcard d-flex flex-column flex-sm-row justify-content-around mb-3 mb-md-4 p-md-3 p-2" key={travel.id}>
                            <img className="rounded imagecard m-2 m-sm-1" src={travel.image} alt="image" />
                            <div className="p-2">
                                ...
                                <div className="d-flex flex-row justify-content-between  mb-4 durata px-3">
                                    <h4 className="p-1 p-md-2 text-center">Inizio: {formattedStart}</h4>
                                ...
                                <div className="d-flex flex-row flex-wrap justify-content-between align-items-center">
                                    ...
                                    {travel.discountPrice && <h6 className="mb-4 p-1 p-md-2 px-3 discount">{travel.discountPrice}€</h6>}
